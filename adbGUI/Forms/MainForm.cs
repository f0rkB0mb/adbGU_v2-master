namespace adbGUI.Forms
{
    ...
    public partial class MainForm : Form, IDisposable
    {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void tsmSaveContent_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                System.IO.File.WriteAllText(path, tmpContent);
            }
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void tsmClearContent_Click(object sender, EventArgs e)
        {
            rtb_console.Clear();
        }

        private void tsmEditContentFont_Click(object sender, EventArgs e)
        {
            if (fontDlg.ShowDialog() == DialogResult.OK)
            {
                rtb_console.Font = fontDlg.Font;
            }
        }

        private void tsmEditContentColor_Click(object sender, EventArgs e)
        {
            if (colorDlg.ShowDialog() == DialogResult.OK)
            {
                rtb_console.ForeColor = colorDlg.Color;
            }
        }

        private void rtb_console_TextChanged(object sender, EventArgs e)
        {
            tmpContent = string.Format("{0}\r\n{1}\r\n", tmpContent, rtb_console.Text);
        }

        private void rtb_console_SelectionChanged(object sender, EventArgs e)
        {
            tsmCopySelectedText.Enabled = true;
        }

        private void tsmCopySelectedText_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(rtb_console.SelectedText))
            {
                Clipboard.SetText(rtb_console.SelectedText);
            }
        }
        ...
        {
            trv_commandTreeView.CollapseAll();
        }
    }
}